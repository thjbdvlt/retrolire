...
import (
	...
	"polyanthea/internal/actions"
	"polyanthea/internal/bibtex"
	"polyanthea/internal/cli/opts"
	"polyanthea/internal/cli/pick"
	"polyanthea/internal/config"
	"polyanthea/internal/edit"
	"polyanthea/internal/files"
	"polyanthea/internal/nlp"
	"polyanthea/internal/nlp/word2vec"
	"polyanthea/internal/note"
	"polyanthea/internal/obj"
	"polyanthea/internal/sqlmaker"
	"polyanthea/internal/state"
	"polyanthea/internal/tui"
)
...
func getCommandFromArgs(args []string, options *opts.Opts) ([]string, cliCommand) {
	...
	// So "polyanthea cite -q" is just like "polyanthea textobj-cite 2"
