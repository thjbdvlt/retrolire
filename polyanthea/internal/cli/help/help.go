// Package help - Help messages for polyanthea
package help
...
// USAGE - Help message
const USAGE = `polyanthea - command line bibliography manager

SYNOPSIS
  polyanthea <command> [options] [filters]
...
EXAMPLES
  polyanthea init
  polyanthea edit --quote author:antin .read
  polyanthea open .unread .fiction
  polyanthea list author:wittgenstein,kripke .important
  polyanthea cite --concept .philosophy
  polyanthea update title
  polyanthea add json - < mycsl.json
